...
if __name__ == "__main__":
    ...
    sents = sent_seg(doc_string)
    """
    NOOOOOOOOOOOOOOOTICE:

    To avoid any potential misunderstanding, this API is ONLY used for simple demonstration.
    If you want to reproduce the results as reported in the PTPCG paper,
        please follow the instructions in README.md !
    """
    results = dee_task.predict_one(sents)
    print(results)
