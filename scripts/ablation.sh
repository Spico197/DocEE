...

{
    ...
    TASK_NAME='PTPCG-P1-woTgg-lowImpt-woAtLeastOneComb-DuEEfin'
    RUN_MODE='dueefin_wo_tgg'
    TEMPLATE='dueefin_wo_tgg_low_importance'
    INFERENCE_DUMPPATH='PTPCG-P1-woTgg-lowImpt-woAtLeastOneComb-DuEEfin.json'
