...
class EquityPledgeEvent(BaseEvent):
    NAME = '质押'
    FIELDS = ['Trigger', '质押物占总股比', '质权方', '质押方', '事件时间', '质押股票/股份数量', '质押物所属公司', '质押物', '质押物占持股比', '披露时间']
    ...
    TRIGGERS = {
        ...
        6: ['Trigger', '质押方', '质押物占总股比', '质押物占持股比', '质押股票/股份数量', '质权方'],  # importance: 0.975
        7: ['Trigger', '事件时间', '质押方', '质押物占总股比', '质押物占持股比', '质押股票/股份数量', '质权方'],  # importance: 0.975
        8: ['Trigger', '事件时间', '质押方', '质押物占总股比', '质押物占持股比', '质押物所属公司', '质押股票/股份数量', '质权方'],  # importance: 0.975
        9: ['Trigger', '事件时间', '质押方', '质押物', '质押物占总股比', '质押物占持股比', '质押物所属公司', '质押股票/股份数量', '质权方'],  # importance: 0.975
    }
    TRIGGERS['all'] = ['质押股票/股份数量', '质押物占持股比', 'Trigger', '质押物占总股比', '事件时间', '质押方', '质押物', '披露时间', '质押物所属公司', '质权方']
...
class ShareRepurchaseEvent(BaseEvent):
    NAME = '股份回购'
    FIELDS = ['Trigger', '每股交易价格', '交易金额', '回购完成时间', '回购股份数量', '占公司总股本比例', '回购方', '披露时间']
    ...
    TRIGGERS = {
        ...
        6: ['Trigger', '交易金额', '占公司总股本比例', '回购完成时间', '回购股份数量', '每股交易价格'],  # importance: 1.0
        7: ['Trigger', '交易金额', '占公司总股本比例', '回购完成时间', '回购方', '回购股份数量', '每股交易价格'],  # importance: 1.0
        8: ['Trigger', '交易金额', '占公司总股本比例', '回购完成时间', '回购方', '回购股份数量', '披露时间', '每股交易价格'],  # importance: 1.0
    }
    TRIGGERS['all'] = ['回购股份数量', '回购完成时间', 'Trigger', '交易金额', '每股交易价格', '回购方', '占公司总股本比例', '披露时间']
...
class ReleasePledgeEvent(BaseEvent):
    NAME = '解除质押'
    FIELDS = ['Trigger', '质权方', '质押物占总股比', '质押方', '事件时间', '质押股票/股份数量', '质押物所属公司', '质押物', '质押物占持股比', '披露时间']
    ...
    TRIGGERS = {
        ...
        5: ['Trigger', '事件时间', '披露时间', '质押物占总股比', '质权方'],  # importance: 0.9745762711864406
        6: ['Trigger', '事件时间', '披露时间', '质押方', '质押物占总股比', '质权方'],  # importance: 0.9745762711864406
        7: ['Trigger', '事件时间', '披露时间', '质押方', '质押物占总股比', '质押股票/股份数量', '质权方'],  # importance: 0.9745762711864406
        8: ['Trigger', '事件时间', '披露时间', '质押方', '质押物占总股比', '质押物所属公司', '质押股票/股份数量', '质权方'],  # importance: 0.9745762711864406
        9: ['Trigger', '事件时间', '披露时间', '质押方', '质押物', '质押物占总股比', '质押物所属公司', '质押股票/股份数量', '质权方'],  # importance: 0.9745762711864406
    }
    TRIGGERS['all'] = ['Trigger', '质押股票/股份数量', '事件时间', '质押方', '质押物', '披露时间', '质押物占持股比', '质押物所属公司', '质权方', '质押物占总股比']
...
class BusinessAcquisitionEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        7: ['Trigger', '交易金额', '披露时间', '收购完成时间', '收购方', '收购标的', '被收购方'],  # importance: 1.0
    }
...
class ShareholderOverweightEvent(BaseEvent):
    NAME = '股东增持'
    FIELDS = ['Trigger', '每股交易价格', '交易金额', '增持部分占所持比例', '交易完成时间', '增持方', '交易股票/股份数量', '增持部分占总股本比例', '股票简称', '披露时间']
    ...
    TRIGGERS = {
        ...
        7: ['Trigger', '交易完成时间', '交易金额', '增持方', '增持部分占所持比例', '每股交易价格', '股票简称'],  # importance: 1.0
        8: ['Trigger', '交易完成时间', '交易股票/股份数量', '交易金额', '增持方', '增持部分占所持比例', '每股交易价格', '股票简称'],  # importance: 1.0
        9: ['Trigger', '交易完成时间', '交易股票/股份数量', '交易金额', '增持方', '增持部分占总股本比例', '增持部分占所持比例', '每股交易价格', '股票简称'],  # importance: 1.0
    }
    TRIGGERS['all'] = ['增持方', '股票简称', '交易股票/股份数量', '交易完成时间', 'Trigger', '披露时间', '增持部分占总股本比例', '交易金额', '每股交易价格', '增持部分占所持比例']
...
class ExecutivesChangeEvent(BaseEvent):
    NAME = '高管变动'
    FIELDS = ['Trigger', '变动后职位', '任职公司', '高管姓名', '披露日期', '变动类型', '事件时间', '高管职位', '变动后公司名称']
    ...
    TRIGGERS = {
        ...
        5: ['Trigger', '任职公司', '变动后职位', '变动类型', '高管姓名'],  # importance: 0.9701492537313433
        6: ['Trigger', '任职公司', '变动后职位', '变动类型', '披露日期', '高管姓名'],  # importance: 0.9701492537313433
        7: ['Trigger', '事件时间', '任职公司', '变动后职位', '变动类型', '披露日期', '高管姓名'],  # importance: 0.9701492537313433
        8: ['Trigger', '事件时间', '任职公司', '变动后职位', '变动类型', '披露日期', '高管姓名', '高管职位'],  # importance: 0.9701492537313433
        9: ['Trigger', '事件时间', '任职公司', '变动后公司名称', '变动后职位', '变动类型', '披露日期', '高管姓名', '高管职位'],  # importance: 0.9701492537313433
    }
    TRIGGERS['all'] = ['高管姓名', 'Trigger', '变动类型', '高管职位', '变动后职位', '任职公司', '事件时间', '披露日期', '变动后公司名称']
...
class WinBidEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        7: ['Trigger', '中标公司', '中标日期', '中标标的', '中标金额', '披露日期', '招标方'],  # importance: 1.0
    }
...
class CompanyIPOEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        5: ['Trigger', '上市公司', '事件时间', '募资金额', '证券代码'],  # importance: 0.9878048780487805
        6: ['Trigger', '上市公司', '事件时间', '募资金额', '环节', '证券代码'],  # importance: 0.9878048780487805
        7: ['Trigger', '上市公司', '事件时间', '募资金额', '发行价格', '环节', '证券代码'],  # importance: 0.9878048780487805
        8: ['Trigger', '上市公司', '事件时间', '募资金额', '发行价格', '披露时间', '环节', '证券代码'],  # importance: 0.9878048780487805
        9: ['Trigger', '上市公司', '事件时间', '募资金额', '发行价格', '市值', '披露时间', '环节', '证券代码'],  # importance: 0.9878048780487805
    }
    TRIGGERS['all'] = ['上市公司', 'Trigger', '事件时间', '披露时间', '证券代码', '募资金额', '发行价格', '市值', '环节']
...
class CompanyFinancingEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        7: ['Trigger', '事件时间', '披露时间', '融资轮次', '融资金额', '被投资方', '领投方'],  # importance: 1.0
        8: ['Trigger', '事件时间', '投资方', '披露时间', '融资轮次', '融资金额', '被投资方', '领投方'],  # importance: 1.0
    }
...
class ShareholderUnderweightEvent(BaseEvent):
    NAME = '股东减持'
    FIELDS = ['Trigger', '减持方', '每股交易价格', '交易金额', '减持部分占所持比例', '交易完成时间', '交易股票/股份数量', '减持部分占总股本比例', '股票简称', '披露时间']
    ...
    TRIGGERS = {
        ...
        4: ['Trigger', '交易股票/股份数量', '减持部分占总股本比例', '股票简称'],  # importance: 0.9523809523809523
        5: ['Trigger', '交易完成时间', '交易股票/股份数量', '减持方', '股票简称'],  # importance: 0.9863945578231292
        6: ['Trigger', '交易完成时间', '交易股票/股份数量', '减持方', '每股交易价格', '股票简称'],  # importance: 0.9863945578231292
        7: ['Trigger', '交易完成时间', '交易股票/股份数量', '交易金额', '减持方', '每股交易价格', '股票简称'],  # importance: 0.9863945578231292
        8: ['Trigger', '交易完成时间', '交易股票/股份数量', '交易金额', '减持方', '减持部分占所持比例', '每股交易价格', '股票简称'],  # importance: 0.9863945578231292
        9: ['Trigger', '交易完成时间', '交易股票/股份数量', '交易金额', '减持方', '减持部分占总股本比例', '减持部分占所持比例', '每股交易价格', '股票简称'],  # importance: 0.9863945578231292
    }
    TRIGGERS['all'] = ['减持方', '股票简称', '交易完成时间', '减持部分占总股本比例', '交易股票/股份数量', 'Trigger', '披露时间', '交易金额', '每股交易价格', '减持部分占所持比例']
...
event_type_fields_list = [
    ...
    (ShareRepurchaseEvent.NAME, ShareRepurchaseEvent.FIELDS, ShareRepurchaseEvent.TRIGGERS, 2),
    (ReleasePledgeEvent.NAME, ReleasePledgeEvent.FIELDS, ReleasePledgeEvent.TRIGGERS, 2),
    (InvitedConversationEvent.NAME, InvitedConversationEvent.FIELDS, InvitedConversationEvent.TRIGGERS, 2),
    (BusinessAcquisitionEvent.NAME, BusinessAcquisitionEvent.FIELDS, BusinessAcquisitionEvent.TRIGGERS, 2),
    (ShareholderOverweightEvent.NAME, ShareholderOverweightEvent.FIELDS, ShareholderOverweightEvent.TRIGGERS, 2),
    (ExecutivesChangeEvent.NAME, ExecutivesChangeEvent.FIELDS, ExecutivesChangeEvent.TRIGGERS, 2),
    ...
    # (CompanyIPOEvent.NAME, CompanyIPOEvent.FIELDS, CompanyIPOEvent.TRIGGERS, 2),
    (CompanyFinancingEvent.NAME, CompanyFinancingEvent.FIELDS, CompanyFinancingEvent.TRIGGERS, 2),
    (CompanyLossEvent.NAME, CompanyLossEvent.FIELDS, CompanyLossEvent.TRIGGERS, 2),
    (ShareholderUnderweightEvent.NAME, ShareholderUnderweightEvent.FIELDS, ShareholderUnderweightEvent.TRIGGERS, 2),
    (CompanyBankruptEvent.NAME, CompanyBankruptEvent.FIELDS, CompanyBankruptEvent.TRIGGERS, 2),
]
