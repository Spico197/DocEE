...
class EquityFreezeEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        3: ['EndDate', 'LegalInstitution', 'UnfrozeDate'],  # importance: 0.7272727272727273
        4: ['EndDate', 'EquityHolder', 'LegalInstitution', 'UnfrozeDate'],  # importance: 0.8121212121212121
        5: ['EndDate', 'LegalInstitution', 'StartDate', 'TotalHoldingRatio', 'TotalHoldingShares'],  # importance: 0.8454545454545455
        6: ['EndDate', 'FrozeShares', 'LegalInstitution', 'TotalHoldingRatio', 'TotalHoldingShares', 'UnfrozeDate'],  # importance: 0.8818181818181818
        7: ['EndDate', 'FrozeShares', 'LegalInstitution', 'StartDate', 'TotalHoldingRatio', 'TotalHoldingShares', 'UnfrozeDate'],  # importance: 0.9303030303030303
...
class EquityRepurchaseEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        2: ['HighestTradingPrice', 'RepurchaseAmount'],  # importance: 0.9522260953166496
        3: ['ClosingDate', 'HighestTradingPrice', 'RepurchaseAmount'],  # importance: 0.9740680713128039
        4: ['CompanyName', 'LowestTradingPrice', 'RepurchaseAmount', 'RepurchasedShares'],  # importance: 0.9918962722852512
        5: ['ClosingDate', 'CompanyName', 'HighestTradingPrice', 'LowestTradingPrice', 'RepurchasedShares'],  # importance: 0.9983792544570502
...
class EquityUnderweightEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        3: ['EndDate', 'LaterHoldingShares', 'TradedShares'],  # importance: 0.9554973821989529
        4: ['AveragePrice', 'EquityHolder', 'LaterHoldingShares', 'StartDate'],  # importance: 0.9973821989528796
        5: ['AveragePrice', 'EndDate', 'EquityHolder', 'LaterHoldingShares', 'TradedShares'],  # importance: 0.9973821989528796
...
class EquityOverweightEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        3: ['EndDate', 'LaterHoldingShares', 'TradedShares'],  # importance: 0.9424603174603174
        4: ['AveragePrice', 'EndDate', 'EquityHolder', 'TradedShares'],  # importance: 0.998015873015873
        5: ['AveragePrice', 'EndDate', 'EquityHolder', 'LaterHoldingShares', 'StartDate'],  # importance: 1.0
...
class EquityPledgeEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        3: ['Pledgee', 'StartDate', 'TotalHoldingRatio'],  # importance: 0.7768595041322314
        4: ['EndDate', 'Pledgee', 'Pledger', 'StartDate'],  # importance: 0.8220965637233579
        5: ['PledgedShares', 'ReleasedDate', 'TotalHoldingRatio', 'TotalHoldingShares', 'TotalPledgedShares'],  # importance: 0.902131361461505
        6: ['EndDate', 'PledgedShares', 'Pledger', 'ReleasedDate', 'TotalHoldingRatio', 'TotalPledgedShares'],  # importance: 0.9238799478033928
        7: ['PledgedShares', 'Pledgee', 'ReleasedDate', 'StartDate', 'TotalHoldingRatio', 'TotalHoldingShares', 'TotalPledgedShares'],  # importance: 0.9399739016963897
        8: ['EndDate', 'PledgedShares', 'Pledger', 'ReleasedDate', 'StartDate', 'TotalHoldingRatio', 'TotalHoldingShares', 'TotalPledgedShares'],  # importance: 0.9521531100478469
