...
class EquityFreezeEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        3: ['FrozeShares', 'LegalInstitution', 'StartDate'],  # importance: 0.9242424242424242
        4: ['EquityHolder', 'FrozeShares', 'LegalInstitution', 'StartDate'],  # importance: 0.9303030303030303
        5: ['EquityHolder', 'FrozeShares', 'LegalInstitution', 'StartDate', 'TotalHoldingRatio'],  # importance: 0.9333333333333333
        6: ['EquityHolder', 'FrozeShares', 'LegalInstitution', 'StartDate', 'TotalHoldingRatio', 'UnfrozeDate'],  # importance: 0.9363636363636364
        7: ['EquityHolder', 'FrozeShares', 'LegalInstitution', 'StartDate', 'TotalHoldingRatio', 'TotalHoldingShares', 'UnfrozeDate'],  # importance: 0.9363636363636364
...
class EquityRepurchaseEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        4: ['ClosingDate', 'CompanyName', 'RepurchaseAmount', 'RepurchasedShares'],  # importance: 1.0
        5: ['ClosingDate', 'CompanyName', 'HighestTradingPrice', 'RepurchaseAmount', 'RepurchasedShares'],  # importance: 1.0
...
class EquityUnderweightEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        3: ['EquityHolder', 'StartDate', 'TradedShares'],  # importance: 0.9973821989528796
        4: ['EndDate', 'EquityHolder', 'StartDate', 'TradedShares'],  # importance: 0.9973821989528796
        5: ['EndDate', 'EquityHolder', 'LaterHoldingShares', 'StartDate', 'TradedShares'],  # importance: 0.9973821989528796
...
class EquityOverweightEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        3: ['EquityHolder', 'StartDate', 'TradedShares'],  # importance: 0.998015873015873
        4: ['EquityHolder', 'LaterHoldingShares', 'StartDate', 'TradedShares'],  # importance: 1.0
        5: ['EndDate', 'EquityHolder', 'LaterHoldingShares', 'StartDate', 'TradedShares'],  # importance: 1.0
...
class EquityPledgeEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        4: ['EndDate', 'PledgedShares', 'ReleasedDate', 'StartDate'],  # importance: 0.9499782514136581
        5: ['EndDate', 'PledgedShares', 'Pledgee', 'ReleasedDate', 'StartDate'],  # importance: 0.9543279686820356
        6: ['EndDate', 'PledgedShares', 'Pledgee', 'Pledger', 'ReleasedDate', 'StartDate'],  # importance: 0.9560678555893867
        7: ['EndDate', 'PledgedShares', 'Pledgee', 'Pledger', 'ReleasedDate', 'StartDate', 'TotalPledgedShares'],  # importance: 0.9565028273162245
        8: ['EndDate', 'PledgedShares', 'Pledgee', 'Pledger', 'ReleasedDate', 'StartDate', 'TotalHoldingShares', 'TotalPledgedShares'],  # importance: 0.9565028273162245
