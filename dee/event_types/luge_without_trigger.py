...
class EquityPledgeEvent(BaseEvent):
    NAME = '质押'
    FIELDS = ['质押物占总股比', '质权方', '质押方', '事件时间', '质押股票/股份数量', '质押物所属公司', '质押物', '质押物占持股比', '披露时间']
    ...
    TRIGGERS = {
        ...
        6: ['披露时间', '质押方', '质押物占总股比', '质押物占持股比', '质押股票/股份数量', '质权方'],  # importance: 0.95
        7: ['事件时间', '披露时间', '质押方', '质押物占总股比', '质押物占持股比', '质押股票/股份数量', '质权方'],  # importance: 0.95
        8: ['事件时间', '披露时间', '质押方', '质押物占总股比', '质押物占持股比', '质押物所属公司', '质押股票/股份数量', '质权方'],  # importance: 0.95
        9: ['事件时间', '披露时间', '质押方', '质押物', '质押物占总股比', '质押物占持股比', '质押物所属公司', '质押股票/股份数量', '质权方'],  # importance: 0.95
    }
    TRIGGERS['all'] = ['质押股票/股份数量', '质押物占持股比', '质押物占总股比', '事件时间', '质押方', '质押物', '披露时间', '质押物所属公司', '质权方']
...
class ShareRepurchaseEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        7: ['交易金额', '占公司总股本比例', '回购完成时间', '回购方', '回购股份数量', '披露时间', '每股交易价格'],  # importance: 1.0
    }
...
class ReleasePledgeEvent(BaseEvent):
    NAME = '解除质押'
    FIELDS = ['质权方', '质押物占总股比', '质押方', '事件时间', '质押股票/股份数量', '质押物所属公司', '质押物', '质押物占持股比', '披露时间']
    ...
    TRIGGERS = {
        ...
        5: ['事件时间', '披露时间', '质押物', '质押股票/股份数量', '质权方'],  # importance: 0.9067796610169492
        6: ['事件时间', '披露时间', '质押物', '质押物占总股比', '质押股票/股份数量', '质权方'],  # importance: 0.9067796610169492
        7: ['事件时间', '披露时间', '质押方', '质押物', '质押物占总股比', '质押股票/股份数量', '质权方'],  # importance: 0.9067796610169492
        8: ['事件时间', '披露时间', '质押方', '质押物', '质押物占总股比', '质押物所属公司', '质押股票/股份数量', '质权方'],  # importance: 0.9067796610169492
        9: ['事件时间', '披露时间', '质押方', '质押物', '质押物占总股比', '质押物占持股比', '质押物所属公司', '质押股票/股份数量', '质权方'],  # importance: 0.9067796610169492
    }
    TRIGGERS['all'] = ['质押股票/股份数量', '事件时间', '质押方', '质押物', '披露时间', '质押物占持股比', '质押物所属公司', '质权方', '质押物占总股比']
...
class ShareholderOverweightEvent(BaseEvent):
    NAME = '股东增持'
    TRIGGERS = ['交易股票/股份数量', '股票简称', '交易金额', '增持方', '交易完成时间', '增持部分占总股本比例', '每股交易价格', '披露时间', '增持部分占所持比例']
    FIELDS = ['每股交易价格', '交易金额', '增持部分占所持比例', '交易完成时间', '增持方', '交易股票/股份数量', '增持部分占总股本比例', '股票简称', '披露时间']
    ...
    TRIGGERS = {
        ...
        7: ['交易完成时间', '交易股票/股份数量', '交易金额', '增持方', '增持部分占所持比例', '每股交易价格', '股票简称'],  # importance: 1.0
        8: ['交易完成时间', '交易股票/股份数量', '交易金额', '增持方', '增持部分占总股本比例', '增持部分占所持比例', '每股交易价格', '股票简称'],  # importance: 1.0
        9: ['交易完成时间', '交易股票/股份数量', '交易金额', '增持方', '增持部分占总股本比例', '增持部分占所持比例', '披露时间', '每股交易价格', '股票简称'],  # importance: 1.0
    }
    TRIGGERS['all'] = ['增持方', '股票简称', '交易股票/股份数量', '交易完成时间', '披露时间', '增持部分占总股本比例', '交易金额', '每股交易价格', '增持部分占所持比例']
...
class ExecutivesChangeEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        6: ['事件时间', '任职公司', '变动后职位', '变动类型', '披露日期', '高管姓名'],  # importance: 0.9776119402985075
        7: ['事件时间', '任职公司', '变动后职位', '变动类型', '披露日期', '高管姓名', '高管职位'],  # importance: 0.9776119402985075
        8: ['事件时间', '任职公司', '变动后公司名称', '变动后职位', '变动类型', '披露日期', '高管姓名', '高管职位'],  # importance: 0.9776119402985075
    }
    TRIGGERS['all'] = ['高管姓名', '变动类型', '高管职位', '变动后职位', '任职公司', '事件时间', '披露日期', '变动后公司名称']
...
class CompanyIPOEvent(BaseEvent):
    ...
    TRIGGERS = {
        ...
        6: ['上市公司', '事件时间', '募资金额', '发行价格', '环节', '证券代码'],  # importance: 0.975609756097561
        7: ['上市公司', '事件时间', '募资金额', '发行价格', '披露时间', '环节', '证券代码'],  # importance: 0.975609756097561
        8: ['上市公司', '事件时间', '募资金额', '发行价格', '市值', '披露时间', '环节', '证券代码'],  # importance: 0.975609756097561
    }
...
class ShareholderUnderweightEvent(BaseEvent):
    NAME = '股东减持'
    TRIGGERS = ['交易股票/股份数量', '股票简称', '减持方', '减持部分占总股本比例', '披露时间', '交易金额', '交易完成时间', '每股交易价格', '减持部分占所持比例']
    FIELDS = ['减持方', '每股交易价格', '交易金额', '减持部分占所持比例', '交易完成时间', '交易股票/股份数量', '减持部分占总股本比例', '股票简称', '披露时间']
    ...
    TRIGGERS = {
        ...
        5: ['交易完成时间', '交易股票/股份数量', '减持方', '每股交易价格', '股票简称'],  # importance: 0.9863945578231292
        6: ['交易完成时间', '交易股票/股份数量', '交易金额', '减持方', '每股交易价格', '股票简称'],  # importance: 0.9863945578231292
        7: ['交易完成时间', '交易股票/股份数量', '交易金额', '减持方', '减持部分占所持比例', '每股交易价格', '股票简称'],  # importance: 0.9863945578231292
        8: ['交易完成时间', '交易股票/股份数量', '交易金额', '减持方', '减持部分占总股本比例', '减持部分占所持比例', '每股交易价格', '股票简称'],  # importance: 0.9863945578231292
        9: ['交易完成时间', '交易股票/股份数量', '交易金额', '减持方', '减持部分占总股本比例', '减持部分占所持比例', '披露时间', '每股交易价格', '股票简称'],  # importance: 0.9863945578231292
    }
    TRIGGERS['all'] = ['减持方', '股票简称', '交易完成时间', '减持部分占总股本比例', '交易股票/股份数量', '披露时间', '交易金额', '每股交易价格', '减持部分占所持比例']
