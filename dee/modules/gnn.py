...
class ModelManager(nn.Module):
    ...
    def show_summary(self):
        ...
        logger.info('\tnumber of word:                            {};'.format(self.__num_word))
        logger.info('\tnumber of slot:                            {};'.format(self.__num_slot))
        logger.info('\tnumber of intent:						    {};'.format(self.__num_intent))
        logger.info('\tword embedding dimension:				    {};'.format(self.__args.word_embedding_dim))
        logger.info('\tencoder hidden dimension:				    {};'.format(self.__args.encoder_hidden_dim))
        logger.info('\tdimension of intent embedding:		    	{};'.format(self.__args.intent_embedding_dim))
        logger.info('\tdimension of slot decoder hidden:  	    {};'.format(self.__args.slot_decoder_hidden_dim))
        logger.info('\thidden dimension of self-attention:        {};'.format(self.__args.attention_hidden_dim))
        logger.info('\toutput dimension of self-attention:        {};'.format(self.__args.attention_output_dim))
