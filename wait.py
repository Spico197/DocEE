...
def parse_args(in_args=None):
    ...
    arg_parser.add_argument('--task_name', type=str, required=True,
                            help='Take Name')
    arg_parser.add_argument('--cuda', type=str, required=True,
                            help='cuda to be waited')
    arg_parser.add_argument('--req_gpu_num', type=int, required=False, default=1,
                            help='request number of gpus')
    arg_parser.add_argument('--wait', choices=["schedule", "queue", "none"], default="none",
